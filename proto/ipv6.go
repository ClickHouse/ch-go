...
func binIPv6(b []byte) IPv6 {
	...
	return IPv6{
		High: binary.BigEndian.Uint64(b[0 : 64/8]),
		Low:  binary.BigEndian.Uint64(b[64/8 : 128/8]),
	}
}
...
func binPutIPv6(b []byte, v IPv6) {
	_ = b[:128/8] // bounds check hint to compiler; see golang.org/issue/14808
	// Using BigEndian for IPv6 as per ClickHouse implementation.
	binary.BigEndian.PutUint64(b[64/8:128/8], v.Low)
	binary.BigEndian.PutUint64(b[0:64/8], v.High)
}
